...
\begin{enumerate}
    ...
    $$ \mathbb{E}[\mu^2-\frac{2\mu}{N}\sum_{n=1}^{N}x_n+\frac{1}{N}\sum_{n=1}^{N}\sum_{m=1}^{M}x_n x_m] = 
    \mu^2-\frac{2\mu}{N}\sum_{n=1}^{N}\mathbb{E}[x_n]+\frac{1}{N2}\sum_{n=1}^{N}\sum_{m=1}^{M}\mathbb{E}[x_n x_m] = $$
    $$ \mu^2-2\mu^2+\frac{1}{N^2}(n(\mu^2\sigma^2)+(N^2-N(\mu^2))) = 
    \cancel{\mu^2}-\cancel{2\mu^2}+(\cancel{\frac{\mu^2}{N}}+\frac{\sigma^2}{N}+\cancel{\mu^2}-\cancel{\frac{\mu^2}{N}}) = \boxed{\frac{\sigma^2}{N}} $$    
\end{enumerate}
